...
<body>
	...
	<table border="1">
		...
		<c:forEach var = "search" items = "${result}">
			<tr><td><img src = "${search.userIcon}" style = "width:30px; height:30px;"></td><td id="userid">${search.userId}</td><td>${search.userName}</td><td><input type="hidden" id="" class="${search.userNo}"
