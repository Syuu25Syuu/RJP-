...
<script>
	$(function(){
		...
		if(check_serialno == "まだツイートがありません"){
			$("#check_content").text("まだツイートがありません");
		}
...
<body>
	...
	<form method="post" action="ranking" class = "rank">
		<input type="hidden" name="user_session" value="${sessionScope.token.sessionToken}">
		<input type="hidden" name="check_value" value="good">
		<input type="submit" value="いいね順">
	</form>
	<form method="post" action="ranking" class = "rank">
		<input type="hidden" name="user_session" value="${sessionScope.token.sessionToken}">
		<input type="hidden" name="check_value" value="goodnew">
		<input type="submit" value="最近のいいね順">
	</form>
	<form method="post" action="ranking" class = "rank">
		<input type="hidden" name="user_session" value="${sessionScope.token.sessionToken}">
	...
	<form method="post" action="ranking" class = "rank">
		...
		<input type="submit" value="最近のリツイート数順">
	</form>
 		...
 		<div id="check_content">
		 	...
		 	<div class="tweetdata" id = "tweetdata${data.tweetId}" >
			 	...
			 	<form method = 'post' id="myFORM" action = 'showprofiles'>
			 		...
			 		<input type="hidden" name = "user_session" type = "text" value="${sessionScope.token.sessionToken}">
			 		<input type="hidden" name = "user_id" type = "text" value="${data.serialuserid}" class="check_serialno">
