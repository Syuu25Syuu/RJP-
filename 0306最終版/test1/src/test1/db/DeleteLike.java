...
public class DeleteLike {
	public static void deleteLike(String tweet_id,String sessionToken) throws IntegrationException{
		try{
	...
	public static void allDeleteLike(String tweet_id) throws IntegrationException{
		try{
			Connection cn = new OracleConnector().getCn();
