...
<br><div id="i">ID:<input type="text" pattern="^[0-9A-Za-z]+$" name="id" id="id" placeholder="ID(15文字以内)" size="30" maxlength="15" required>※半角英数</div><br>




		<label>パスワード</label>
		<input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name="pass" id="pass" placeholder="パスワード(8文字以上15文字以内)" size="30" maxlength="15" required>
