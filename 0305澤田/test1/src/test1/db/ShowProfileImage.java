...
public class ShowProfileImage {
	public static ArrayList<MyTweetView_Been> showProfile(String sessionToken,String profUser,Connection cn) throws SQLException{

		System.out.println("------ShowProfileImageへよおこそ------");
        ...
        String prof = GetProfile.getProfile(profUser, cn);		//自己紹介文的な奴だよ

        System.out.println("Profはこれ！"+prof);
