...
public class ComebackHome {
	public static ArrayList comeBackHome(String sessionToken,Connection cn) {
		...
		try{
	        ...
	        //SQL文を変数に格納する
	        String sql="select TWEETS.TWEETS_DATE,rt.RT_TIME,USERS_SERIALNO,USERS_NAME,tweets.TWEETS_SERIALNO,tweets.USERS_NO,tweets.TWEETS_CONTENT,TWEETS.REPLY_TWEET from users "+
	        ...
	        while(rs.next()){
	            ...
	            aStrings[9] = rs.getString("REPLY_TWEET");
