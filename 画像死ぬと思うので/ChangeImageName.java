...
public class ChangeImageName {
	public static String changeImageName(String imageName) {	//サーブレットから受け取る画像ファイル
        ...
        try{
	        ...
	        while(rs.next()){
	        	...
	        	extension = imageName.substring(imageName.lastIndexOf("."));		//サーブレットから受け取った画像の拡張子だけを取得
